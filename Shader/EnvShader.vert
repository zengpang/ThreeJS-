...
void main()
{
    ...
    fresnel=pow((1.-fresnel),fresnelPow);
    vec4 finalfresnel=vec4(fresnel*fresnelPower,fresnel*fresnelPower,fresnel*fresnelPower,1.)*vec4(fresnelColor,1.);
    gl_FragColor=min(finaldiffuse+finalfresnel,1.);
}